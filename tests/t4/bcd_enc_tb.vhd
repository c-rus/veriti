...
begin
    ...
    monitor: process
        ...
        begin
            if endfile(fd) = false then
                ...
                veriti.assert_eq(bfm.bcd, expct.bcd, "bcd");
                veriti.load(row, expct.ovfl);
                veriti.assert_eq(bfm.ovfl, expct.ovfl, "ovfl");
                veriti.load(row, expct.done);
                veriti.assert_eq(bfm.done, expct.done, "done");
            end if;
        end procedure;
    ...
    begin
        ...
        while endfile(outputs) = false loop
            ...
            veriti.monitor(clk, bfm.done, TIMEOUT_LIMIT, timeout);
